/* program 1 in generics usa a hashset to hold the Employee Objects. upon running the application, the detailes of the employees added to the hashset should be displayed */
