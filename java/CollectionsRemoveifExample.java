...
class CollectionsRemoveifExample {
    static List<Employee2> employee2List = new ArrayList<>();

    public static void main(String[] args) {
        employee2List.add(new Employee2("John", 25, 7000.00));
        employee2List.add(new Employee2("Mary", 45, 100000.00));
        employee2List.add(new Employee2("Peter", 65, 8000.00));
        employee2List.add(new Employee2("Jorge", 22, 12000.00));
        employee2List.add(new Employee2("Jhansi", 29, 9000.00));
